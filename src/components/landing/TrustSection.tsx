            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  [창립자/운영자 프로필 텍스트 placeholder]<br />
                  저도 수십 개의 플래너를 실패했어요. 
                  의지력 탓을 하다 지쳤죠. 
                  결국 '시스템'으로 접근해야 한다는 걸 깨달았고, 
                  이 플래너를 만들게 되었습니다.
                </p>
                <div>
                  <p className="font-bold text-foreground">[이름 placeholder]</p>
                  <p className="text-sm text-muted-foreground">[직함/소개 placeholder]</p>
                </div>
              </div>
            </div>
          </div>
